...
[^1]: Your sample collection starts on 1st November 2022. On day 5, you analyse the data in the laboratory for totals solids (TS) in g/L. In your spreadsheet, note the exact date of each collected sample.
    ...
    Day 1: 5 samples at households using pit latrines Day 2: 5 samples at households using septic tanks Day 3: 5 samples at public toilets that are pit latrines Day 4: 5 samples at public toilets that are septic tanks Day 5: Analyses of all 20 samples for total solids (TS) in g/L on a lab scale with accuracy of 0.01 g Make up the results for the total solids (TS) analyses (e.g. 12.48 g/L).
